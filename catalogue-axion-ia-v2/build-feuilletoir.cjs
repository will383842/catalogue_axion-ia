...
<!-- APERCU DE PARTAGE
     Sans ces balises, ce lien s'affiche en URL nue dans WhatsApp, LinkedIn,
     Slack ou un mail — alors que c'est LE lien qu'on partage, celui qui ouvre
     le catalogue. Un PDF, lui, ne peut jamais porter d'apercu : aucun reseau
     ne lit les metadonnees d'un PDF. Le lien a partager reste donc CETTE page.
     L'URL de l'image doit etre ABSOLUE : les robots des reseaux ne resolvent
     pas les chemins relatifs. -->
<meta property="og:type" content="website">
<meta property="og:site_name" content="Axion-IA">
<meta property="og:locale" content="fr_FR">
<meta property="og:url" content="https://axion-ia.com/catalogue/index.html">
<meta property="og:title" content="Catalogue Axion-IA 2026-2027 — 48 pages, à feuilleter">
<meta property="og:description" content="21 formations et un séminaire, accompagnement 1-to-1, audit IA, implémentation &amp; automatisation. Prix publics, prise en charge OPCO sans avance.">
<meta property="og:image" content="https://axion-ia.com/catalogue/og-catalogue.jpg">
<meta property="og:image:type" content="image/jpeg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Le catalogue Axion-IA 2026-2027 ouvert, 48 pages">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Catalogue Axion-IA 2026-2027 — 48 pages, à feuilleter">
<meta name="twitter:description" content="21 formations et un séminaire, accompagnement 1-to-1, audit IA, implémentation &amp; automatisation.">
<meta name="twitter:image" content="https://axion-ia.com/catalogue/og-catalogue.jpg">
<style>
...
(function () {
  ...
  // pas() regarde i et i+1 : c'est le pas pour AVANCER. L'employer pour
  // reculer fait passer par des vues que la marche avant ne produit jamais :
  // depuis la 4e de couverture, on tombait sur la page 47 SEULE, alors qu'elle
  // fait face a la 46. Le pas arriere est le miroir : il regarde ce qui est
  // DERRIERE i, donc i-1 et i-2.
  // (aucun backtick dans ce commentaire : il vit dans un litteral gabarit.)
  function pasArriere() { return (MOBILE() || seule(i - 1) || seule(i - 2)) ? 1 : 2; }
  function precedent() {
    cacherAide();
    if (enCours || i <= 0) return;
    tourner(-1, function () { i = Math.max(0, i - pasArriere()); rendre(); });
  }
  ...
  function allerA(n) {
    ...
    // sinon demander la 45 afficherait 45|46 — un appariement que le livre n'a
    // pas. Les pages affichees seules gardent leur position.
    //
    // ⚠️ LA PARITE PORTE SUR L'INDEX, PAS SUR LE FOLIO. PAGES[0] est la page 1,
    // donc une double commence a un index IMPAIR : PAGES[1]|PAGES[2] = 2|3,
    // PAGES[43]|PAGES[44] = 44|45. Un index PAIR est donc une page de droite,
    // qu'il faut reculer d'un cran.
    //
    // Ce test etait ecrit k % 2 === 1, herite du feuilletoir KDP ou les
    // couvertures sont des entrees separees et ou la parite est donc inversee.
    // Ici il faisait exactement le contraire de ce que son propre commentaire
    // annoncait : demander la 45 affichait 45|46.
    if (!MOBILE() && !seule(k) && k % 2 === 0) k -= 1;
    i = k;
    cacherAide();
    rendre();
    return true;
